...
namespace RayFire
{
    ...
    public class RFDemolitionCluster
    {
        ...
        public static void PostDemolitionCluster (RayfireRigid scr, List<RFShard> detachShards)
        {
            ...
            // Create Rigid Shards
            CreateRigidDetachShards (scr, detachShards);
        ...
        static void CreateRigidDetachShards (RayfireRigid scr, List<RFShard> detachShards)
        {
            // No shards to create
            ...
            {
                //if (detachShards[i].rigid.fading.onDemolition == true)
                {
                    // detachShards[i].rigid.Fade();
                }
            }
        }
        ...
        public static void CreateClusterRuntime (RayfireRigid scr, RFCluster cluster)
        {
            ...
            // Set parent
            RayfireMan.SetParent (cluster.tm, scr.transForm);
