            ...
            if (scr.demolitionType == DemolitionType.ReferenceDemolition)
            {
                ...
                if (refScr != null)
                {
                             ...
                             refScr.objectType == ObjectType.SkinnedMesh)
                    {
                        ...
                        if (refScr.meshFilter == null && refScr.skinnedMeshRend == null)
                            return true;
                             ...
                             refScr.objectType == ObjectType.ConnectedCluster)
                    {
                        ...
                        if (refScr.clusterDemolition.cluster.shards.Count > 0)
                            scr.fragments.Add (refScr);
                    }
                }
            }
