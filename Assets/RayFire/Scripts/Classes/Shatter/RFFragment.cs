...
namespace RayFire
{
    ...
    public static class RFFragment
    {
        ...
        static RFShatter SetShatter (
            ...
            bool deleteCol,      
            int seed = 1,    
            FragmentMode mode = FragmentMode.Runtime, 
            bool preCap = true, 
            bool remCap = false, 
            bool remDbl = true, 
            bool exInside = false, 
            ...
            int percSize = 3)
        {
            ...
            if (mode == FragmentMode.Editor)
            {
                ...
                SetShatterEditorMode(shatter, sizeFilter, preCap, remCap, remDbl, exInside, smooth);
            }
            else
                SetShatterRuntimeMode (shatter, smooth);
        ...
        static void SetShatterEditorMode(RFShatter shatter, float sizeFilter, bool preCap, bool remCap, bool remDbl, bool exInside, bool smooth)
        {
            ...
            //  shatter.SetGeneralParameter(RFShatter.GeneralParams.post_weld, true);
        ...
        static void SetShatterRuntimeMode(RFShatter shatter, bool smooth)
        {
